    ...
    >
      ...
      {node.skillPoints > 0 && (
        <motion.div
          ...
          className={cn(
            "absolute -top-1 -right-1 px-1.5 py-0.5 rounded-full text-xs font-black flex items-center gap-0.5",
            isCompleted 
      ...
      {node.courseCode && (
        <div className={cn(
          "absolute -bottom-6 left-1/2 -translate-x-1/2 px-2 py-0.5 rounded text-[10px] font-mono font-bold whitespace-nowrap",
      ...
      <div className={cn(
        "absolute top-full mt-8 left-1/2 -translate-x-1/2 px-3 py-2 rounded-lg text-xs font-medium whitespace-nowrap",
